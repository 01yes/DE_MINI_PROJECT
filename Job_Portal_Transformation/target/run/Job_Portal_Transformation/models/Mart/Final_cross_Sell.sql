        ...
        create or replace transient table JOB_PORTAL_TRANFORMATION_DB.JOB_TRANSFORMED_SCHEMA.Final_cross_Sell
         as
...
(
    ...
    FROM 
        JOB_PORTAL_TRANFORMATION_DB.JOB_TRANSFORMED_SCHEMA.Product_tr 
    JOIN
